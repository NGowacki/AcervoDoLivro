        ...
        <div class="row justify-content-center">
            <div class="col-sm-8 col-18">
                ...
                <div class="card p-4">
                    ...
                    <p class="text-center mb-4"> Deseja deletar o Autor? </p>
                    <h4 class="mb-4 text-center"><strong><?= $autor['nome'] ?></strong></h4>
                    <div class="text-center mb-4">
                        <span><i class="fa-solid fa-at me-1"></i>Nacionalidade: <?= $autor['nacionalidade']?></strong></span>
                        <span class="mx-5"></span> <span><i class="fa-solid fa-phone me-2°"></I>Bibliografia:<?= $autor['bibliografia'] ?></strong></span>
                    </div>
                    <div class=" text-center my-3">
                        <a href="meusAutores.php" class="btn btn-outline-secondary px-5"><i class="fa-solid fa-xmark me-2"></i>Não</a>   <a href="processaDeleteAutor.php?id=<?= $autor['id'] ?>" class="btn btn-secondary px-5"><i class="fa-solid fa-check me-2"></i>Sim</a>
                    </div>
                </div>
            </div>
        </div>
